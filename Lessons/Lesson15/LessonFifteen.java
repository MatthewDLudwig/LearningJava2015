...
public class LessonFifteen extends Lesson {
	 ...
	 * 	The NOTODO tag:
	 * 		As you should already see, the word NOTODO is highlighed differently from the rest of the comment. 
...
//		NOTODO  Make sure that the string return by toString makes sense (for arrays may have to use Arrays class).
		return o.toString();
	}
